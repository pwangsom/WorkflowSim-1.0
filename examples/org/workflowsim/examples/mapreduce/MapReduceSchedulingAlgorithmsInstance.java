...
public class MapReduceSchedulingAlgorithmsInstance {
...
/*          Parameters.SchedulingAlgorithm sch_method = Parameters.SchedulingAlgorithm.DATA_MR;
    ...
    private JobScheduledResult createJobScheduledResultList(List<Integer> scheduledJobList, List<Job> outputJobList){
